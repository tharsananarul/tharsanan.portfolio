...
export default function CV() {
  return (
    <main className="relative pb-20 bg-transparent min-h-screen overflow-hidden">
      ...
      {/* Download button */}
      <div className="section-container -mt-16 md:-mt-32 mb-2 md:mb-4 relative z-10">
        <motion.div
        ...
        >
          <Magnetic>
            <a href="documents/cv-tharsanan-final.pdf" download className="btn-premium gap-3 text-lg px-10 py-5 group">
        ...
        <div className="grid lg:grid-cols-[1fr_1.5fr] gap-16 lg:gap-32">
          ...
          <div className="space-y-16">
            ...
            <div className="space-y-12">
              ...
              <div className="mt-16 relative perspective-[1200px] flex justify-center md:justify-start">
                <a href={`${import.meta.env.BASE_URL}documents/cv-tharsanan-final.pdf`} target="_blank" rel="noreferrer" className="block">
                  <motion.div
